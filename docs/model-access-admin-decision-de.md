...
Konsequenz fürs Frontend: Die drei User-Views (`/commons`, `/jobs`, `/run`) sind für jeden eingeloggten User dieselben Routen. Der einzige echte Routen-Branch ist **Admin vs. Nicht-Admin**.
